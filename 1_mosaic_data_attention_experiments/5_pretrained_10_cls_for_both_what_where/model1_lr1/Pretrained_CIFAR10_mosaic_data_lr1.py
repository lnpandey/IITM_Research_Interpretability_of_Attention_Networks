...
for epoch in range(nos_epochs):
    ...
    for i, data in enumerate(trainloader):
        ...
        if cnt % 40 == 39:    # print every 6 mini-batches
            ...
            running_loss = 0.0
            torch.save(net.state_dict(),"weight_pretrained1/net_epoch"+str(epoch)+".pt")
...
what = Net()
what.load_state_dict(torch.load("weight_pretrained1/net_epoch99.pt"))
...
class Wherenet(nn.Module):
    def __init__(self):
        ...
        self.helper = Net()
        self.helper.load_state_dict(torch.load("weight_pretrained1/net_epoch99.pt"))
...
#                 print(inputs.shtorch.save(where.state_dict(),"model_epoch"+str(epoch)+".pt")ape,labels.shape)
        ...
        torch.save(where.state_dict(),"weight_pretrained1/where_model_epoch"+str(epoch)+".pt")
        torch.save(what.state_dict(),"weight_pretrained1/what_model_epoch"+str(epoch)+".pt")
    
print('Finished Training')
torch.save(where.state_dict(),"weight_pretrained1/where_model_epoch"+str(nos_epochs)+".pt")
torch.save(what.state_dict(),"weight_pretrained1/what_model_epoch"+str(epoch)+".pt")
...
df_train.to_csv("weight_pretrained1/train_results.csv",index=False)
df_test.to_csv("weight_pretrained1/test_results.csv",index=False)
