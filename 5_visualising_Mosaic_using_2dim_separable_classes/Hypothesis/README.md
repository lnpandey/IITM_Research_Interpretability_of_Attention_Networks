...
| Random          | Random                     |   Both                   |   77.33   |<img src= ./plots/both_lineardeep_randomb_D_4_K_10.png width="150">|               
| Random          | Random                     |   Focus                  |   70.76   | <img src= ./plots/focus_lineardeep_randomb_D_4_K_10.png width="150">|
| Random          | Random                     |   classify               |   65      | <img src= ./plots/classify_lineardeep_randomb_D_4_K_10.png width="150">  |
| Random          | Pretrained                 |   -                      | 61.13     | NA                                                                  |
| Random          | Pretrained                 |   Both                   | 77.16    | <img src= ./plots/both_lineardeep_randomf_D_4_K_10.png width="150">|               
| Random          | Pretrained                 |   Focus                  |  73.1    | <img src= ./plots/focus_lineardeep_randomf_D_4_K_10.png width="150">     |
| Random          | Pretrained                 |   classify               |   65.26  | <img src= ./plots/classify_lineardeep_randomf_D_4_K_10.png width="150">  |    
| Pretrained      | Random                     |   -                      |   52.86  | NA                                                                  |
| Pretrained      | Random                     |   Both                   | 77.8   |<img src= ./plots/both_lineardeep_randomc_D_4_K_10.png width="150">   |               
| Pretrained      | Random                     |   Focus                  | 64.7    |<img src= ./plots/focus_lineardeep_randomc_D_4_K_10.png width="150">     |
| Pretrained      | Random                     |   classify               |    75.3 | <img src= ./plots/classify_lineardeep_randomc_D_4_K_10.png width="150">   | 
| Pretrained      | Pretrained                 |   -                      |   72.66   | NA                                                                  |
| Pretrained      | Pretrained                 |   Both                   |   77.23  |<img src= ./plots/both_lineardeep_norandom_D_4_K_10.png width="150">  |            
| Pretrained      | Pretrained                 |   Focus                  |    72.8  |<img src= ./plots/focus_lineardeep_norandom_D_4_K_10.png width="150">    |
| Pretrained      | Pretrained                 |   classify               |   75.06      |<img src= ./plots/classify_lineardeep_norandom_D_4_K_10.png width="150">  |     
