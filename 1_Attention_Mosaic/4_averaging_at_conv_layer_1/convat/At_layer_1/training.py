...
classification_net  = Classification_Module(8,3).double()
...
optimizer_focus = optim.Adam(focus_net.parameters(),lr = 0.001)
optimizer_classification = optim.Adam(classification_net.parameters(),lr = 0.001)


#scheduler_focus = optim.lr_scheduler.ExponentialLR(optimizer_focus, gamma=0.05)
#scheduler_classification = optim.lr_scheduler.ExponentialLR(optimizer_classification,gamma = 0.05)
# In[14]:
