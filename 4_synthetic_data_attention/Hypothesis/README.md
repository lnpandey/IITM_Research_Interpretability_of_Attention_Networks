...
| --------| ---------------------- | ------------------------ | ------------------------ | ----------------------------- | ---------------------------- | ------------------  |   --------- | ------------------- |
| D_1_K_2 |    100  |   100    |  100 | 100  |    59 |      99.6/50   |  100   |  100  |  
...
| ------   |  ---------------------------------------    |    --------------------------------------   |
| D_1_K_2  | <img src= ./plots/non_linearly_separable_d_1_k_2.png width="150">  |  <img src= ./plots/deep_non_linearly_separable_d_1_k_2.png width="150"> |
