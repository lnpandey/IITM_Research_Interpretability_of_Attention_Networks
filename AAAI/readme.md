...
|S.No.| Dataset | Average layer | Architecture | nos_of_runs | Entropy | k-value | LR | avg Acc | avg FTPT | best runs | avg best Acc | avg best FTPT | 
|-----|----|---------------|--------------|-------------|---------|--------|--------|----------|-----------|--------------|---------------|-------------|
| 1.  |Dataset2 | zeroth  | architecture1 | 10 | NO    | 0    | 0.001 | 99.99 | 89.13 | 10  | 99.99 | 89.13 |
| 2.  |Dataset2 | zeroth  | architecture1 | 10 | Yes   | 0.001| 0.001 |  |  |   |  |  |
| 3.  |Dataset2 | zeroth  | architecture1 | 10 | Yes   | 0.002| 0.001 |  |  |  |   |    |
| 4.  |Dataset2 | zeroth  | architecture1 | 10 | Yes   | 0.01 | 0.001 |  |  |  |   |    |
| 5.  |Dataset2 | zeroth  | architecture1 | 10 | Yes   | 0.02 | 0.001 |  |  |  |   |    |
| 6.  |Dataset2 | first   | architecture1 | 10 | NO    | 0    | 0.001 | 100 | 93.53 | 10  | 100 | 93.53 |
| 7.  |Dataset2 | first   | architecture1 | 10 | Yes   | 0.001| 0.001 |  | |  | | |
| 8.  |Dataset2 | first   | architecture1 | 10 | Yes   | 0.005| 0.001 |  | |  | | |
| 9.  |Dataset2 | first   | architecture1 | 10 | Yes   | 0.01 | 0.001 |  | |  | | |
| 10. |Dataset2 | first   | architecture1 | 10 | Yes   | 0.02 | 0.001 |  | |  | | |
