...
Original file is located at
    https://colab.research.google.com/drive/1Dt1t3ws9F4f6KYxAav4k74LOx7DNWXRA
"""
...
def train_all(trainloader, ds_number, testloader_list):
    ...
    torch.save(inc.state_dict(),"weights/train_dataset_"+str(ds_number)+"_"+str(epochs)+".pt")
...
np.save("train_loss1.npy",train_loss_all)
